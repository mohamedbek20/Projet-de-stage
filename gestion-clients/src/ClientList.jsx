...
const ClientList = ({ clients = [], onSelectClient, onClientUpdated, onDeleteClient, onAddClient }) => {
  ...
  const filteredClients = useMemo(() => {
    if (!activeSearchTerm) return clients;
    return clients.filter(client => 
      client.email.toLowerCase().includes(activeSearchTerm.toLowerCase()) ||
      client.telephone.toLowerCase().includes(activeSearchTerm.toLowerCase())
    );
  }, [clients, activeSearchTerm]);

  // Mise à jour de la pagination pour utiliser les clients filtrés
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col space-y-8">
        ...
        <div className="flex justify-start mb-4">
          <form className="flex items-center max-w-sm" onSubmit={handleSearch}>
